                            ...
                            <SplideSlide key={i} className='mb-0.5'>
                                <div className='relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200'>
                                    ...
                                    <div className='flex items-center justify-between w-full px-4'>
                                        ...
                                        <div className='flex items-center gap-0.5'>
                                            <ClockIcon className='icon-style w-4 h-4 text-slate-800 ' />
                                            <span className='text-xs font-bold'>{val.time}</span>
                                        </div>
                                        <div className='flex items-center gap-0.5'>
                                            <HashtagIcon className='icon-style text-blue-800 ' />
                                            <span className='text-xs font-bold text-blue-600'>{val.by}</span>
                                        </div>
                                    </div>
                                    <div className='grid items-center justify-items-start px-4'>
                                        <h3 className='text-base font-semibold lg:text-sm'>{val.title}</h3>
